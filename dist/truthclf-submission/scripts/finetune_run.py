...
invoked with --launch; without the flag it prints the config and exits. The
resulting LoRA adapter is served via a dedicated endpoint for evaluation (see
README and evaluate_finetuned.py).
