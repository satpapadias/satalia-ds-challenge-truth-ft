...
Cross-check: does the field that occlusion shows actually drove the prediction
match what the rationale cites? Disagreement exposes rationalization. The agreement
